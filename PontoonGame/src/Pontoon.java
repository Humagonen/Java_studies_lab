...
// sent to mieshal
//	public static int WinningIndex(ArrayList<ArrayList<String>> hands) {
//
...
//	    }
//
//	    // Check if no hands are provided
//	    if (hands.isEmpty()) {
//	        return -2;
//	    }
//
...
//	        for (String card : hand) {
//	            if (!allCards.add(card)) { // false if duplicate
//	                return -4;
//	            }
//	        }
//	    }
//
//	    // Initialize variables to track the winning hand
//	    int indexWon = -1;
//	    int maxScore = -1;
//	    int fewestCards = -1;
//
//	    // Loop through each hand to determine the winner
//	    for (int i = 0; i < hands.size(); i++) {
//	        ArrayList<String> hand = hands.get(i);
//	        int score = Q3_Method(hand); // gets arraylist as input
//
//	        // Skip hands that bust
//	        if (score > 21) continue;
//
//	        // Update winner if:
//	        // 1. Score is higher than current max, or
//	        // 2. Same score but fewer cards used
//	        if (score > maxScore || (score == maxScore && (fewestCards == -1 || hand.size() < fewestCards))) {
//	            maxScore = score;
//	            indexWon = i;
...
//	    }
//
//	    // If no valid winning hand is found
//	    if (indexWon == -1) {
//	        return -3;
//	    }
//
//	    // Return index of winning hand
//	    return indexWon;
//	}
